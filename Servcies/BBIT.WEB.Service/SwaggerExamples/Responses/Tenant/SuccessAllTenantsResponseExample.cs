...
{
    public class SuccessAllTenantsResponseExample : IExamplesProvider<SuccessAllTenantsResponse>
    {
        public SuccessAllTenantsResponse GetExamples()
        {
            return new SuccessAllTenantsResponse
            {
                Status = true,
                Tenants = new []
                {
