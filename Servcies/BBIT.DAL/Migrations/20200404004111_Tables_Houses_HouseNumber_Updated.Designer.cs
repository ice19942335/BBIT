...
namespace BBIT.DAL.Migrations
{
    ...
    [Migration("20200404004111_Tables_Houses_HouseNumber_Updated")]
    partial class Tables_Houses_HouseNumber_Updated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BBIT.Domain.Entities.Auth.Identity.User.AppUser", b =>
                {
            ...
            modelBuilder.Entity("BBIT.Domain.Entities.Auth.JWT.RefreshToken", b =>
                {
            ...
            modelBuilder.Entity("BBIT.Domain.Entities.Auth.JWT.RefreshToken", b =>
                {
                    b.HasOne("BBIT.Domain.Entities.Auth.Identity.User.AppUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BBIT.Domain.Entities.Auth.Identity.User.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
